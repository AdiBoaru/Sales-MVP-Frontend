  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
        ...
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center gap-4">
          ...
          <div className="flex-1 max-w-md relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-brand-200 focus:border-brand-300 transition-all"
            />
          </div>
          ...
          <div className="flex items-center gap-2 ml-auto">
            <button
              onClick={openAria}
              className="hidden sm:inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-700 text-white text-sm font-semibold px-4 py-2 rounded-xl transition-colors"
            >
              <MessageCircle className="w-3.5 h-3.5" /> Consultanță
            </button>
            <Link
              to="/Cart"
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        {/* Page title */}
        <div className="mb-6">
          <p className="text-xs font-semibold tracking-widest text-brand-600 uppercase mb-1">Catalogul {BRAND.name}</p>
            ...
            <div className="flex items-center justify-between mb-5">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="text-sm border border-gray-200 rounded-xl px-3 py-1.5 bg-white focus:outline-none focus:ring-2 focus:ring-brand-200 cursor-pointer"
                >
                  {sortOptions.map((o) => (
